...
output_dir = '/net/litho/atmosdyn2/svoigt/project_extremes/temp/'
    ...
    for mm in month:
        ...
        for dd in range(1, nday_per_month[mm - 1] + 1):
            ...
            for yyyy in range(ref_y0, ref_y1 + 1):
                ...
                # to subtract 2 because of the size of the boosting window. then we add days_previous in case there are days from the previous month
                ...
                # the day we are looking at. we need to add 2 because of the size of the boosting window. then we add 1 because of the python structure
                ...
                data_field[index+days_previous+days_next:index+2*timewin+1,:,:] = inp_field[dd-3+days_previous:dd-1+2+1-days_next,:,:]
